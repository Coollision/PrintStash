...
from app.runtime.jobs import JobRegistry, safe_error, safe_item
...
class TestJobUpdate:
    ...
    def test_pending_registry_prunes_entries_past_ttl(self, owner: User) -> None:
        registry_ = ingest_background._PendingRegistry()
        stale = ingest_background._PendingModelFiles(
            page_url="https://x",
            page_title="x",
...
from app.modules.ingestion import import_resolvers, importer  # noqa: E402
from app.modules.ingestion.importer import ImportError_  # noqa: E402
...
class TestSelectModelFiles:
    ...
    def test_select_model_files_rejects_empty_selection(
        ...
        token = ingest_background.pending_model_files.add(
            ingest_background._PendingModelFiles(
...
class TestSelectCollectionMembers:
    ...
    def test_select_collection_members_rejects_empty_selection(
        ...
        token = ingest_background.pending_collections.add(
            ingest_background._PendingCollection(
                title="Cool",
