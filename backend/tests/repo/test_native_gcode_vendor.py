...
def test_pins_the_verified_direct_dependency_versions_and_features() -> None:
...
def test_builds_only_the_upstream_sources_needed_for_bounded_inspection() -> None:
